...
import { BookOpenText, LayoutGrid, MessageSquareText, Sparkles, TimerReset } from "lucide-react";

const links = [
  { to: "/student", label: "Dashboard", icon: LayoutGrid },
  { to: "/student/materials", label: "Materials", icon: BookOpenText },
  { to: "/student/updates", label: "Updates", icon: MessageSquareText },
  { to: "/student/schedule", label: "Schedule", icon: TimerReset },
];
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row">
        <aside className="w-full rounded-[2rem] border border-slate-200/70 bg-slate-950/95 p-5 text-white shadow-[0_25px_100px_-30px_rgba(15,23,42,0.8)] lg:w-72 lg:p-6">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-2 text-cyan-200"><Sparkles size={18} /></div>
            <div>
